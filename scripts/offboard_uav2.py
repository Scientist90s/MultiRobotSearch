...
if __name__ == "__main__":
    rospy.init_node("offb_uav2_node")

    pose_sub = rospy.Subscriber('/uav2/mavros/local_position/pose', PoseStamped, callback = drone_pose_cb)
    state_sub = rospy.Subscriber("/uav2/mavros/state", State, callback = state_cb)
